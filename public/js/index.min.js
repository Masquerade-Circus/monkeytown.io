(function (global, factory) {
	...
	var Factory = function () {
	    ...
	    return {
	        ...
	        initClient: function initClient(entity, Entities) {
	            ...
	            var lifeBar = Game.cssModels.BarFactory('red');
	            lifeBar.name = 'life';
	...
	var Page$1 = {
	    ...
	    getBuyButton: function getBuyButton(id, item, level) {
	        ...
	        return v( 'button', { onclick: Page$1.buy, 'data-id': id }, label);
	    },
	    ...
	    getItems: function getItems() {
	        ...
	        return Object.keys(config_6).map(function (id) {
	            ...
	            return v( Panel, { position: "inline", color: "black" }, item.name, " ", level, " ", selected);
	        });
	    },
	    ...
	    getMiddleMessage: function getMiddleMessage() {
	    ...
	    getLeaderboard: function getLeaderboard() {
	        return Game$1.leaderboard.map(function (item, index) {
	            return v( 'div', { style: item.id === Game$1.player.id ? 'color: #7ac31b' : '' }, index, " - ", item.name, " (", item.score, ")");
	        });
	    },
	    view: function view() {
	        if (Game$1.player) {
	            if (Game$1.player[config_1.HasDied]) {
	                return v( 'article', { oninit: Page$1.onupdate, onupdate: Page$1.onupdate },
	                    v( Panel, { position: "center middle", color: "black" }, Page$1.getMiddleMessage())
	                );
	            }
