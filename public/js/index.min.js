(function (global, factory) {
	...
	var Factory$3 = function (Game) {
	    ...
	    Object.values(config_5).forEach(function (item) { return Game.player[config_1.Inventory][item] = 0; });
	    ...
	    view: function view() {
	        if (Game$1.player) {
	            return v( 'article', { oninit: Page$1.onupdate, onupdate: Page$1.onupdate },
	                v( Panel, { title: "Inventory", position: "left top", color: "black" },
	                    v( 'ul', null,
	                        Object.keys(config_5).map(function (item) {
	                            return v( 'li', null, item, ": ", Game$1.player[config_1.Inventory][config_5[item]] );
	                        })
	                    )
	                ),
