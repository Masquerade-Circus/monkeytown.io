(function (global, factory) {
	    ...
	    return {
	        ...
	        initClient: function initClient(entity) {
	            ...
	            var Fighting = {
	                ...
	                update: function update(rotateAngle) {
	                    var angle = Math.min(rotateAngle - THREE.Math.radToDeg(Model.rotation.y, 70));
	                    Model.rotateY(THREE.Math.degToRad(angle));
	                }
	            };
	            entity.addScript('fightAnimation', function () {
	...
	var playerEntityFactory = Factory$1;
	...
	var treeEntityFactory = Factory$2;
