(function (global, factory) {
	...
	var Factory$4 = function () {
	    return {
	        Model: 'Sheep',
	        initServer: function initServer(entity, Entities) {
	            var Game = Entities.Game;
	            var Config = config$1;
	            var PROPS = Config.PROPS;
	            var STATUS = Config.STATUS;
	            var NET_TYPES = Config.NET_TYPES;
	            entity.addScript('fight', function () {
	                entity[PROPS.Status] = STATUS.Fighting;
	                setTimeout(function () { return entity[PROPS.Status] = STATUS.Static; }, 400);
	            });
	            ...
	            entity.applyDamage = function (damage) {
	                var obj;
	                ...
	                if (entity[PROPS.Life] < 0) {
	                    ...
	                    entity.remove = true;
	                    Game.addEntity(Entities.create(( obj = {}, obj[PROPS.NetType] = NET_TYPES.Sheep, obj[PROPS.Position] = Game.getRandomPointInRegion(), obj.world = entity.world, obj )));
	                    return;
	                }
	            ...
	            entity.ai.randomMovement = function (distance) {
	                if ( distance === void 0 ) distance = 10;

	                var position = entity.body.position.clone();
	                ...
	                var randomTime = Game.getRandomNumber(5000, 7000);
	                clearTimeout(entity.ai.timeout);
	                entity.ai.timeout = setTimeout(function () { return entity.ai.randomMovement(); }, randomTime);
	            };
	            ...
	            entity.ai.receivedDamage = function () {
	                if (!entity.ai.damaged) {
	                    ...
	                    setTimeout(function () { return entity.ai.damaged = false; }, 5000);
	                }
	            };

	            entity.addScript('start', function () {
	        ...
	        initClient: function initClient(entity, ref) {
	            var Game = ref.Game;
	...
	var sheepEntityFactory = Factory$4;
	...
	ENTITIES[NET_TYPES.Sheep] = sheepEntityFactory;
	...
	var CssModels = {
	    BarFactory: Factory$6,
	    LabelFactory: Factory$7
	};
	                    ...
	                    v( Panel, { position: "inline", color: "black" },
	                        v( 'form', null,
	                            ...
	                            v( 'div', { class: "text-center" },
	                                v( 'button', {
	                                    onclick: Page.play, 'data-background': "success", disabled: !Game$1.is.ready || Game$1.is.connecting, class: "w75" },
	                        ...
	                        v( 'br', null ),
	                        v( 'div', { class: "text-justify", style: "height: 250px; overflow: auto" },
	                            v( 'b', null, "How to play" ),
	                            v( 'br', null ), "Collect resources to buy better equipment and gold to be the number one. ", v( 'br', null ),
	                            v( 'br', null ), v( 'b', null, "Controls" ),
	                            v( 'br', null ), v( 'code', null, "WASD" ), " To move ", v( 'br', null ), v( 'code', null, "Mouse" ), " To look ", v( 'br', null ), v( 'code', null, "Left button" ), " To gather resources / fight other players ", v( 'br', null ), v( 'code', null, "Mousewheel/1-4" ), " To equip item ", v( 'br', null ),
	                            v( 'br', null ), v( 'b', null, "Strategies" ),
	                            v( 'br', null ), "If you have enough resources you can buy weapons and you can increase its effectivity by upgrading from stone to iron, silver and gold levels.  With the correct resources the store will automatically appear and show the items you can buy. ", v( 'br', null ), v( 'br', null ), "Sheeps will give you food and gold. ", v( 'br', null ), v( 'br', null ), "Knife is fast to buy and upgrade, it gives you a little more range and probability to gather resources and ​a little more fight power. ", v( 'br', null ), v( 'br', null ), "Axe will give you medium range and more probability to gather resources and medium fight power. ", v( 'br', null ), v( 'br', null ), "Spear will give you the largest range but no probability increase to gather resources and high fight power. ", v( 'br', null ),
	                            v( 'br', null ), v( 'b', null, "Roadmap" ),
	                            v( 'br', null ), "[ ] - ​Add more animals (birds, lion, wild boar) ", v( 'br', null ), "[ ] - Add more items (bow, sword) ", v( 'br', null ), "[ ] - Add items to build your house (walls, door, traps)")
	                    )
	                )
	            ),
