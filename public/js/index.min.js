(function (global, factory) {
	...
	var config_5 = config$1.INVENTORY;

	var Factory$3 = function (Game) {
	    var obj;

	    Game.player[config_1.Inventory] = ( obj = {}, obj[config_5.Wood] = 0, obj[config_5.Stone] = 0, obj[config_5.Iron] = 0, obj[config_5.Silver] = 0, obj[config_5.Gold] = 0, obj );
	    ...
	    view: function view() {
	        if (Game$1.player) {
	            return v( 'article', { oninit: Page$1.onupdate, onupdate: Page$1.onupdate },
	                v( Panel, { title: "Inventory", position: "left top" }, "Wood: ", Game$1.player[config_1.Inventory][config_5.Wood],
	                    v( 'br', null ), "Stone: ", Game$1.player[config_1.Inventory][config_5.Stone],
	                    v( 'br', null ), "Iron: ", Game$1.player[config_1.Inventory][config_5.Iron],
	                    v( 'br', null ), "Silver: ", Game$1.player[config_1.Inventory][config_5.Silver],
	                    v( 'br', null ), "Gold: ", Game$1.player[config_1.Inventory][config_5.Gold]
	                ),
