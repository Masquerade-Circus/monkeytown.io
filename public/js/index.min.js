(function (global, factory) {
	...
	var Page$1 = {
	    ...
	    getBuyButton: function getBuyButton(name, level) {
	        ...
	        return v( 'button', { onclick: Page$1.buy, 'data-item': name }, label);
	    },
	    getStore: function getStore() {
	        return Object.keys(config_6).map(function (name) {
	            ...
	            if (
	                ...
	                return Page$1.getBuyButton(name, level);
	            }
	    ...
	    getItems: function getItems() {
	        var equiped = Object.values(config_6)[Game$1.player[config_1.Equiped]];
	        return Object.keys(config_6).map(function (name) {
	            var item = config_6[name];
	            var level = Game$1.player[config_1.Inventory][item.id];
	            var selected = equiped.id === item.id;
	            return v( Panel, { position: "inline", color: "black" }, name, " ", level, " ", selected);
	        });
	    },
