	    ...
	    var Connection = {
	        ...
	        connectServer: function connectServer(world) {
	            ...
	            return new Promise(function (resolve) {
	                Game.socket.emit('connectServer', world, function (entity) {
	            ...
	            v( Panel, { position: "center middle" }
	                ...
	                v( 'div', { 'data-flex': "" },
	                    v( Panel, { position: "inline", color: "white" },
	                        ...
	                        v( 'button', {
	                            onclick: Page.play, 'data-background': "success", disabled: !Game$1.ready, class: "w100" },
	                            Game$1.ready ? 'Play' : 'Loading...'
	                        )
	                    ),
	...
	var Page$1 = {
	    ...
	    view: function view() {
	        return v( 'article', { onupdate: Page$1.onupdate },
	            v( Panel, { position: "center middle" }, "Welcome, this is the game ui.")
	        );
	    }
	};
