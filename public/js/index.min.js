(function (global, factory) {
	        ...
	        v( Panel, { position: "center middle" }
	            ...
	            v( 'div', { 'data-flex': "" },
	                v( Panel, { position: "inline", color: "white" },
	                    ...
	                    v( 'select', null,
	                        v( 'option', null, "Server name" )
	                    ),
	                    v( 'button', { 'data-background': "success", class: "w100" }, "Play")
	                ),
	    ...
	    var Connection = {
	        ...
	        connectServer: function connectServer(world) {
	            ...
	            return new Promise(function (resolve) {
	                Game.socket.emit('connectServer', world, function () {
	...
	var Game$1 = {
	        ...
	        for (var i$1 in world.children) {
	            if (Game$1.children[i$1] === undefined) {
	                ...
	                if (i$1 === Game$1.playerId) {
	                    ...
	                    Game$1.player.socket = Game$1.socket;
	    ...
	    connectServer: function () { return Game$1.connection.connectServer(); },
	    worlds: {},
