(function (global, factory) {
	...
	var ENTITIES = {
	    ...
	    Models: {},
	    init: function init() {
	        ENTITIES.Models[TYPES.Player] = entityPlayer();
	    },
	...
	var Connection = {
	    ...
	    connectServer: function connectServer() {
	        return new Promise(function (resolve) {
	            socket.emit('connectServer', function () {
	...
	var test = function (Game) {
	    ...
	    var entity = Entities.create(( obj = {}, obj[Entities.PROPS.netType] = 1, obj ));
	    ...
	    setTimeout(function () { return entity.destroy(); }, 5000);
